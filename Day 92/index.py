...
img = r"Day 92/dinoo1.1.gif"
img1 = r"Day 92/dino1.1.gif"
img2 = r"Day 92/dino2.1.gif"
obj1 = r"Day 92/obs1.1.gif"
bgpic = r"Day 92/bgpic.png"
awrodh = r"Day 92/awrodh.gif"
binduimg = r"Day 92/dust.gif"
cloudimg = r"Day 92/cloud.gif"
obj2 = r"Day 92/obs2.1.gif"
obj3 = r"Day 92/obs3.1.gif"
obj4 = r"Day 92/obs4.1.gif"
obj5 = r"Day 92/obs5.1.gif"
...
while True:
   ...
   if dino.distance(obs1) <= distance or dino.distance(obs2) <= distance:
      pen.goto(-30,170)
      pen.write("Game over",align="left", font=("Arial", 12, "bold"))
      while True:
         if keyboard.is_pressed("up") or keyboard.is_pressed("space"):
            count = 0
            dx = 1
   ...
   pen.clear()
   pen.write(str(score), align="left", font=("Arial", 12, "bold")) 
