...
def save_text():
    ...
    try:
        ...
        with open('Day 89/writeups.txt', 'a') as f:
...
heading = "DISAPPEARING TEXT APP"
instruction = "If you don't press any key for 5 seconds, the text you have written will automatically disappear"
...
reset_btn = Button(text='Clear Text', fg=FG, bg=BG, font=PARA_FONT,
                   highlightbackground=FG, highlightcolor=FG, highlightthickness=0, border=3,
                   command=reset_app, width=50)

save_btn = Button(text='Save Text', fg=FG, bg=BG, font=PARA_FONT,
                   highlightbackground=FG, highlightcolor=FG, highlightthickness=0, border=3,
